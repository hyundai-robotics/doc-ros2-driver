...
⚠️ **Currently, the HD Hyundai Robotics ROS2 driver is supported on controller software version *v60.32-00* or higher. </br> The *v60.32-00* version is scheduled for official release in 2Q 2026, so please refrain from using the ROS2 driver before the official release.**